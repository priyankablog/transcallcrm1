...

{
    ...
    $CI->app_menu->add_sidebar_menu_item('call_summary', [

            'name'     => "Call Summary",

            'href'     => admin_url('call_summary'),
    ...
    if (is_admin()) {
        ...
        $CI->app_menu->add_setup_menu_item('calls_master', [
            'collapse' => true,
            'name'     => "Calls Master",
            'position' => 32,
            'badge'    => [],
        ...
        $CI->app_menu->add_setup_children_item('calls_master', [

            'slug'     => 'wrap_codes',

            'name'     => "Wrap Codes",

            'href'     => admin_url('wrap_codes'),
        ...
        $CI->app_menu->add_setup_children_item('calls_master', [
            ...
            'slug'     => 'data_collection_master',

            'name'     => "Data Collection Master",

            'href'     => admin_url('dc_master'),
        ...
        $CI->app_menu->add_setup_children_item('calls_master', [
            ...
            'slug'     => 'dc_category_master',

            'name'     => "Category Master",

            'href'     => admin_url('dc_category_master'),
