         ...
         <div class="col-md-12">
            ...
            <div class="transcol-box">
               ...
               <div class="transcol-header">
                  <p>Thank you for calling TransCall interpreting Services.This is (____________),May I please have your account number and the language please? </p>
               </div>
                           ...
                           <select class="form-select">
                              ...
                              <?php
                                foreach ($langs as $key) { ?>
                                  <option <?= $key['id']; ?> <?= ($key['id'] == $lang)?"selected":"" ?> ><?= $key['description']; ?></option>
                                 <?php } 
