        ...
        <div class="row">
            ...
            <div class="transcol-box language-box">
               ...
               <div class="transcol-header">
                  <p>Thank you for calling TransCall interpreting Services.This is (____________),May I please have the
                     your account number and language please? </p>
               </div>
               <div class="account-information-box">
                  <div class="account-information-txt">
                     <p>Account Information</p>
                  </div>
                  <div class="account-detail user-name-detail">
                     <div class="client-detail">
                        <p>Client Name</p>
                        <input type="" name="" class="name-filed">
                     </div>
                     <div class="client-detail">
                        <p>Account Name</p>
                        <input type="" name="" class="name-filed">
               ...
               <div class="account-information-box ">
                  ...
                  <div class="account-detail">
                     <div class="client-detail user-call-detail">
                        <p>Phone Number</p>
                        <input type="" name="" class="name-filed">
                     </div>
