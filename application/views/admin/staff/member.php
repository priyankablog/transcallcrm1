...
<div id="wrapper">
    ...
    echo ' hide';
                              ...
                              ?>
                                ...
                                <?php $value = (isset($member) ? $member->unique_id : ''); ?>
                                <div class="form-group" app-field-wrapper="unique_id"><label for="unique_id" class="control-label"> <small class="req text-danger">* </small>Unique ID</label><input type="text" id="unique_id" name="unique_id" class="form-control" autocomplete="off" value="<?= (isset($member))? $member->unique_id:'' ?>"></div>
        ...
        appValidateForm($('.staff-form'), {
            ...
            unique_id: {
                ...
                remote: {
                    ...
                    url: admin_url + "misc/staff_uniqueid_exists",
                    ...
                    data: {
                        ...
                        unique_id: function() {
                            ...
                            return $('input[name="unique_id"]').val();
