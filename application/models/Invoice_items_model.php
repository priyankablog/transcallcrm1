...

{
...

    {
     ...
     public function get_language($id = '',$client_id =null)

    {
        ...
        $this->db->select($rateCurrencyColumns . '' . db_prefix() . 'items.id as itemid,rate,
            ...
            '. db_prefix() . 'item_client.price as master_rate,
        ...
        $this->db->join('' . db_prefix() . 'item_client',  db_prefix() . 'item_client.item_id = ' . db_prefix() . 'items.id AND '.db_prefix() . 'item_client.company_id = '.$client_id, 'left');
